...
<body>
	...
	<div class="titulo" style="position: fixed; z-index: 1;">
		<font id="fonte1" style="margin: 2%; left: 40%; font-family: Courier New; font-size: 70px;">Fórum</font>
				...
				<tr>
					...
					<td valign="top">
						...
						<div style="margin-left: 3px;">
							<input id="bt1" type="submit" value="Enviar" name="btenvia">
						</div>
					</td>
				</tr>
			</form>
	...
	<fieldset>
		<!--BORDA DA TABELA-->
		<legend>
			&nbsp; <font size="4">Fórum de Mensagens:</font> &nbsp;
		</legend>
