...
<head>
	...
	<meta charset="utf-8">
	<title>TekMind | Matérias | Tópicos Avançanos em Informática</title>
	<style type="text/css">
		* { margin: 0; padding: 0; }
...
<body>	
		...
		<nav><br><br><br>
			<!--LOGO-->
			<div class="logo"><img src="imagens/logoNova.png" width="98" height="100"></div><br>
			...
			<div class="item">
				...
				<ul>
					<li><a href="prog3.php">Programação III</a></li>
					<li><a href="empre.php">Empreendedorismo</a></li>
					<li><a href="topicos.php">Tópicos Avançados em Informática</a></li>
					<li><a href="tcc.php">TCC (Trabalho de Conclusão de Curso)</a></li>
				</ul>
			</div><br>
		...
		<div class="titulo">
			<div class="materia">
				<img src="imagens/topicoBranco.png" height="90" width="90"><br>
				<font size="4"><b>TÓPICOS AVANÇADOS EM INFORMÁTICA</b></font>
			</div>
		</div><br><br><br><br>
		<br><br><br>
