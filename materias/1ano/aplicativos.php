...
<head>
	...
	<meta charset="utf-8">
	<title>TekMind | Matérias | Aplicativos</title>
	<style type="text/css">
		*{margin: 0; padding: 0;}
...
<body>	
		...
		<div class="titulo">
			<div class="materia">
				<img src="imagens/aplicativosBranco.png" height="90" width="90"><br>
				<font size="4"><b>APLICATIVOS</b></font>
			</div>
		</div><br><br><br><br>
		<br><br><br>
		...
		<div class="menu">
			...
			<div class="item">
				...
				<label for="check8">Conteúdos</label>
				<ul>
			 		<li><a href=""></a></li>
				  	<li><a href=""></a></li>
				</ul>
			...
			<div class="item">
				...
				<label for="check9">Questões</label>
				<ul>
			 		<li><a href=""></a></li>
				  	<li><a href=""></a></li>
				</ul>
